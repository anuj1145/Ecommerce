            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li class=""><a><i class="fa fa-cog"></i> Category Manager <span class="fa fa-chevron-down"></span></a>
                  ...
                  <li class=""><a><i class="fa fa-cog"></i> Product Manager <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu" style="display: none;">
