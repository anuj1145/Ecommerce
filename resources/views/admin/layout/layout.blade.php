...
<html lang="en">
  ...
  <body class="nav-md">
   ...
   @include('admin.layout.header')
    ...
    <!-- Bootstrap -->
    <script src="{{asset('public/admin_theme/vendors/bootstrap/dist/js/bootstrap.bundle.min.js')}}"></script>
	...
	@stack('footer-script')    <!-- This script is used in index.blade.php at the end -->
  </body>
</html>
