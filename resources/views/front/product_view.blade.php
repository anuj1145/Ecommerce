@extends('front.layout.layout')
	...
	<div class="row">	  
            ...
            <a href="public/themes/images/products/large/f1.jpg" title="Fujifilm FinePix S2950 Digital Camera">
				<img src="{{asset('public/uploads/'.$product_details->image)}}" style="width:100%" alt="Fujifilm FinePix S2950 Digital Camera"/>
            </a>
			<div id="differentview" class="moreOptopm carousel slide">
                <!-- <div class="carousel-inner">
                  <div class="item active">
                   <a href="public/themes/images/products/large/f1.jpg"> <img style="width:29%" src="public/themes/images/products/large/f1.jpg" alt=""/></a>
                   <a href="public/themes/images/products/large/f2.jpg"> <img style="width:29%" src="public/themes/images/products/large/f2.jpg" alt=""/></a>
                   <a href="public/themes/images/products/large/f3.jpg" > <img style="width:29%" src="public/themes/images/products/large/f3.jpg" alt=""/></a>
                  </div>
                  <div class="item">
                   <a href="public/themes/images/products/large/f3.jpg" > <img style="width:29%" src="public/themes/images/products/large/f3.jpg" alt=""/></a>
                   <a href="public/themes/images/products/large/f1.jpg"> <img style="width:29%" src="public/themes/images/products/large/f1.jpg" alt=""/></a>
			...
			<div class="span6">
				<h3>{{$product_details->ProductDetail->title}} </h3>
				<small>- (14MP, 18x Optical Zoom) 3-inch LCD</small>
				<hr class="soft"/>
				<form class="form-horizontal qtyFrm">
				  <div class="control-group">
					<label class="control-label"><span>{{$product_details->ProductDetail->title}}</span></label>
					<div class="controls">
					<input type="number" class="span1" placeholder="Qty." value="{{$product_details->ProductDetail->total_items}}"/>
				...
				<hr class="soft"/>
				<h4>{{$product_details->ProductDetail->quantity}} items in stock</h4>
				...
				<hr class="soft clr"/>
				<p>
				{{$product_details->ProductDetail->description}}
		...
		<hr class="soft"/>
			...
			<div class="tab-pane active" id="blockView">
				<ul class="thumbnails">
					<li class="span3">
					  <div class="thumbnail">
						<a href="product_details.html"><img src="public/themes/images/products/10.jpg" alt=""/></a>
						<div class="caption">
